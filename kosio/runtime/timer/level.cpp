#include "kosio/runtime/timer/level.h"
#include <bit>
...
auto kosio::runtime::timer::detail::Level::next_expiration(uint64_t now)
...
auto kosio::runtime::timer::detail::Level::next_occupied_slot(uint64_t now)
...
auto kosio::runtime::timer::detail::Level::take_slot(std::size_t slot) -> EntryList {
    EntryList entries;
