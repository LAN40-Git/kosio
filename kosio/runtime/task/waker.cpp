#include "kosio/runtime/task/waker.h"
...
kosio::runtime::task::waker::Waker::Waker(Waker &&other) noexcept
    : fd_(other.fd_) {
    other.fd_ = -1;
}

auto kosio::runtime::task::waker::Waker::operator=(Waker &&other) noexcept -> Waker & {
    fd_ = other.fd_;
    other.fd_ = -1;
    return *this;
}

void kosio::runtime::task::waker::Waker::wake_up() const {
...
void kosio::runtime::task::waker::Waker::turn_on() {
    if (flag_ != 0) {
        flag_ = 0;
