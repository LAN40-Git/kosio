#pragma once
#include "kosio/io/buf/buffer.hpp"
...
public:
    ...
    [[REMEMBER_CO_AWAIT]]
    auto fill_buf() -> async::Task<Result<void>> {
...
private:
    ...
    auto real_read(std::span<char> buf, Pred pred) -> async::Task<Result<std::size_t>> {
