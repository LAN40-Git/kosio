...
public:
    ...
    [[nodiscard]]
    auto find_flag_and_return_slice(std::string_view end_str) const noexcept -> std::span<const char> {
    ...
    [[nodiscard]]
    auto find_flag_and_return_slice(char end_char) const noexcept -> std::span<const char> {
