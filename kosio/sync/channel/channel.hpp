...
#include "kosio/common/util/ring_buffer.hpp"
...
class Channel {
    ...
    public:
        Channel                &channel_;
        T                      &value_;
        Result<void>            result_{std::unexpected{make_error(Error::kClosedChannel)}};
    ...
    public:
        Channel                &channel_;
        Result<T>               result_{std::unexpected{make_error(Error::kClosedChannel)}};
        std::coroutine_handle<> handle_;
    };
