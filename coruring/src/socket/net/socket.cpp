...
auto coruring::socket::net::TcpSocket::bind(const SocketAddr& addr) noexcept
-> std::expected<void, std::error_code> {
    return inner_.bind<SocketAddr>(addr);
}

auto coruring::socket::net::TcpSocket::listen(int n)
...
auto coruring::socket::net::TcpSocket::connect(const SocketAddr& addr) {
